    ...
    <div class="row">
        ...
        <div class="stores">
            <a href="http://store.steampowered.com/app/212800/" target="_blank">
                <img src="../resources/assets/img/steam.ico" alt="steam" height="40px" width="40px">
            </a>
            <a href="https://itunes.apple.com/us/app/super-crate-box/id483025428?mt=8" target="_blank">
                <img src="../resources/assets/img/App-store.ico" alt="app store" height="40px" width="25px">
            </a>
        </div>
    </div>
